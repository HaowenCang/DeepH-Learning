...
CONSUMER_PATH = REPRO / 'controllers/m9_source_build_v3_consumer.py'
INSTALL_PATH = REPRO / 'controllers/m9_source_build_v3_install.py'
...
class Fixture:
    def __init__(self, installed=True):
        ...
        self.overrides = {'PROJECT': project, 'ROOT': root, 'SNAPSHOT': root / 'controls/source-build-v3',
        ...
        names = ('PROJECT_CONSUMER', 'PROJECT_INSTALLER', 'FROZEN', 'AUTHORIZATION', 'WORK',
                 ...
                 'DECISION', 'AUTH_REVIEW', 'OLD_V2_MANIFEST', 'REPAIR_MANIFEST', 'CHAIN_TEST')
        ...
        state = {'hard_stopped': False, 'active_overlap_transaction': None,
                 'recovered_from_source_build_mpi_failure': c.RECOVERY_ID,
        ...
        tx = {'state': 'FAILED_COMMITTED', 'action': 'source_build',
              'transaction_id': '38a891fff6fd07675581b891766e02c6'}
        ...
        self.frozen = {'schema': 'm9-source-build-frozen-v3', 'files': {
        ...
        self.verdict = {'schema': 'm9-source-build-implementation-verdict-v3', 'status': 'PASS',
        ...
        snapshot = {'schema': 'm9-source-build-snapshot-v3', 'members': {
        ...
        self.gate = {'schema': 'm9-source-build-readiness-v3', 'status': 'PASS', 'scope': c.SCOPE,
        ...
        iv = dict(self.verdict, schema='m9-source-build-installation-verdict-v3',
                  report_path=str(c.INSTALL_REPORT), report_sha256=c.sha(c.INSTALL_REPORT.read_bytes()))
        jwrite(c.INSTALL_VERDICT, iv)
        self.permit = {'schema': 'm9-source-build-execution-permit-v3',
...
class BuildTests(unittest.TestCase):
    ...
    def test_mechanical_permit_requires_fact_and_rejects_reissue(self):
        ...
        verdict = dict(f.verdict, schema='m9-source-build-installation-verdict-v3',
                       report_path=str(c.INSTALL_REPORT), report_sha256=c.sha(c.INSTALL_REPORT.read_bytes()))
