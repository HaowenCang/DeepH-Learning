...
SNAPSHOT = ROOT / 'controls/source-build-v2'
...
PROJECT_CONSUMER = PROJECT / '06_reproduction/controllers/m9_source_build_v2_consumer.py'
PROJECT_INSTALLER = PROJECT / '06_reproduction/controllers/m9_source_build_v2_install.py'
FROZEN = PROJECT / '06_reproduction/manifests/m9_source_build_v2_frozen_hashes.json'
AUTHORIZATION = PROJECT / '08_audits/M9_source_build_v2_user_authorization.md'
WORK = PROJECT / '08_audits/M9_source_build_v2_work_package.md'
TEST = PROJECT / '06_reproduction/tests/test_m9_source_build_v2_consumer.py'
REPORT = PROJECT / '08_audits/M9_source_build_v2_implementation_audit.md'
VERDICT = PROJECT / '08_audits/M9_source_build_v2_implementation_verdict.json'
INSTALL_REPORT = PROJECT / '08_audits/M9_source_build_v2_installation_audit.md'
INSTALL_VERDICT = PROJECT / '08_audits/M9_source_build_v2_installation_verdict.json'
EVIDENCE = PROJECT / '08_audits/M9_source_build_v1_installation_postexecution_evidence.json'
FACT = PROJECT / '08_audits/M9_source_build_v1_installation_audit.md'
...
OPERATION = 'a237ec1f2b404d898840c643e9ae501b'
NONCE = '8034661a857747a62bfbe2c25fb825452aa4dfe7a3d949cda9478e56a18e2a94'
...
EVIDENCE_SHA = '0e125e288af8299fb3cf6447ac379e3b946bd042ddd705537dcd9cff11300f00'
FACT_SHA = '0a6b4ba15309eb8c44707ddf33840f052dca2888fd204502d851e171c77fb86f'
...
def history_attestation(baseline):
    return canonical({'schema':'m9-source-build-history-attestation-v2',
...
def runtime_and_history(reader, baseline, installed=False, private=False):
    """Compare the immutable v1 installation baseline; additions are closed."""
...
def verify_sources(frozen):
    if set(frozen) != {'schema', 'files'} or frozen['schema'] != 'm9-source-build-frozen-v2':
...
def read_snapshot(gate):
    ...
    if set(manifest) != {'schema', 'members'} or manifest['schema'] != 'm9-source-build-snapshot-v2':
    ...
    verify_verdict(json.loads(payloads[VERDICT.name]), 'm9-source-build-implementation-verdict-v2',
...
def validate_gate(gate):
    if (set(gate) != {'schema', 'status', 'scope', 'action', 'operation_id', 'nonce',
            ...
            or gate['schema'] != 'm9-source-build-readiness-v2'
...
def verify_gate(require_permit=True):
    ...
    if require_permit:
        ...
        if (set(permit) != {'schema', 'gate_sha256', 'operation_id', 'nonce',
                ...
                or permit['schema'] != 'm9-source-build-execution-permit-v2'
        ...
        verify_verdict(verdict, 'm9-source-build-installation-verdict-v2',
